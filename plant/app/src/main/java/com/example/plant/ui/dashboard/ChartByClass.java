...
public class ChartByClass extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String[] quarters = new String[]{"原木及其制品", "水果", "粮谷", "棉麻烟草", "植物源性饲料", "其他"};
        ...
        String[][] DATA_TO_SHOW = {{"原木及其制品", String.valueOf(d[0])}, {"水果", String.valueOf(d[1])},
                {"粮谷", String.valueOf(d[2])}, {"棉麻烟草", String.valueOf(d[3])}, {"植物源性饲料", String.valueOf(d[4])}, {"其他", String.valueOf(d[5])}};
